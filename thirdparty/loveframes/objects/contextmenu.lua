...
-- menu object
local newobject = loveframes.NewObject("contextmenu", "loveframes_object_contextmenu", true)
...
function newobject:AddOption(text, icon, func)
	...
	local menuoption = loveframes.objects["contextmenuoption"]:new(self)
...
function newobject:AddSubMenu(text, icon, menu)
	...
	local menuoption = loveframes.objects["contextmenuoption"]:new(self, "submenu_activator", menu)
	menuoption:SetText(text)
	menuoption:SetIcon(icon)
...
function newobject:AddDivider()
	...
	local menuoption = loveframes.objects["contextmenuoption"]:new(self, "divider")
