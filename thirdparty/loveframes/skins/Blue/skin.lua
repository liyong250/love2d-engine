...
--[[---------------------------------------------------------
	- func: DrawBagitem(object)
	- desc: draws the bag item object
--]]---------------------------------------------------------
function skin.DrawBagitem(object)
	...
	if object.toggleable then
		...
		elseif hover then
			...
			x = x - size / 2
			height = height + size
			scaley = height / image_hover:getHeight()
			y = y - size / 2
			-- button body
			love.graphics.setColor(255, 255, 255, 255)
			love.graphics.draw(image_hover, x, y, 0, width, scaley)
			...
			-- button body
			love.graphics.setColor(255, 255, 255, 255)
					-- skin.images["button-nohover.png"]
			love.graphics.draw(image_hover, x, y, 0, width, scaley)
			-- button text
			love.graphics.setFont(font)
			love.graphics.setColor(textnohovercolor)
