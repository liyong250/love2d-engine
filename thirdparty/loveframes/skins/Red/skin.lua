...
function skin.DrawFrame(obj)
	love.graphics.rectangle('line', obj:GetX(), obj:GetY(),
		obj:GetWidth(), obj:GetHeight())
	local topbarimage_height = 20
	love.graphics.line(obj:GetX(), obj:GetY() + topbarimage_height,
		obj:GetX() + obj:GetWidth(), obj:GetY() + topbarimage_height)
end
