...
loveframes.basicfont = love.graphics.newFont(32)
loveframes.basicfontsmall = love.graphics.newFont(20)
loveframes.objects = {}
...
function loveframes.mousepressed(x, y, button)
	...
	for k, v in ipairs(bchildren) do
		...
		if hoverobject then
			...
			if otype == "contextmenu" and visible and htype ~= "menu" and htype ~= "contextmenuoption" then
				v:SetVisible(false)
			end
		else
			if otype == "contextmenu" and visible then
				v:SetVisible(false)
			end
		end
	end
